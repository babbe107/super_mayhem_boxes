function EFFECT:Init(data)
	...
	local emitter = ParticleEmitter(pos)
		...
		for i=1, math.Rand(12, 16) do
			...
			particle:SetVelocity(additional + VectorRand():GetNormalized() * math.Rand(200, 300))
		...
		for i=1, math.Rand(12, 20) do
			local particle = emitter:Add("effects/fire_cloud1", pos + VectorRand() * 8)
			particle:SetVelocity(additional + VectorRand():GetNormalized() * math.Rand(155, 342))
