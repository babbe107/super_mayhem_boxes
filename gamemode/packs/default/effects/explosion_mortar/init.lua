function EFFECT:Init(data)
	...
	sound.Play("weapons/mortar/mortar_explode"..math.random(1, 3)..".wav", pos, 95, math.Rand(80, 90))
	sound.Play("ambient/explosions/exp"..math.random(1, 4)..".wav", pos, 95, math.Rand(95, 105))
	...
	for i=1, math.random(30, 40) do
		local dir = (VectorRand() + normal):GetNormalized()
		local particle = emitter:Add("effects/fire_embers"..math.random(1, 3), pos + dir * 16)
...
function EFFECT:Render()
	...
	if ct < self.DieTime then
		...
		--ToDo: This render effect does not work...
		matRefraction:SetFloat("$refractamount", math.sin(delta * math.pi) * 0.2)
		render.SetMaterial(matRefraction)
		render.UpdateRefractTexture()
		local qsiz = (0.75 - delta) * 1300 -- + math.cos(delta * 12) * 100
		--local eyedir = EyeAngles():Forward()
		--render.DrawQuadEasy(self.Pos, eyedir, qsiz, qsiz, color_white, 0)
		--render.DrawQuadEasy(self.Pos, eyedir * -1, qsiz, qsiz, color_white, 0)
